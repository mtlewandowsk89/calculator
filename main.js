$(function() {
  ...
  //code to make the input fade in/out as you hover over solar panel. Simply adds/removes a class with a css animation.
  var timer;
  $('.solar').hover(function() {
    ...
    timer = setTimeout(function() {
      //adds or removes animation class that fades in/out over 2 seconds.
      $('.inputText').addClass('fadeOut');
      $('.inputText').removeClass('fadeIn');
    }, 100)
  }, function() {
    $('.inputText').removeClass('fadeOut');
    $('.inputText').addClass('fadeIn');
    //resets the timer if you stop hovering over the solar panel.
    clearTimeout(timer);
    timer = null;
  })
